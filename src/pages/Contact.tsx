              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@urbanservices.com</p>
                    <p className="text-gray-600">support@urbanservices.com</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              We have offices in multiple cities to serve you better
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                You can book a service through our website, mobile app, or by calling our customer service number.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                You can cancel your booking up to 2 hours before the scheduled service time without any charges.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-sm">
              ...
              <p className="text-gray-600">
                Yes, all our services come with a 30-day warranty. Some services have extended warranty options.
              </p>
            </div>

            <div className="bg-white rounded-lg p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">How do I track my service request?</h3>
              <p className="text-gray-600">
                You can track your service request through our website or mobile app using your booking ID.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="mailto:info@urbanservices.com" 
